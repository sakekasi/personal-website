...
//var ids = ["about", "experience", "school", "skills", "projects", "interests", "contact"];
var ids = ["about", "experience", "school", "skills", "projects", "contact"];
...
function load_callback(item){return;}

function loadContent(){
	ids.map(function(item){
		$('#'+item+' .content').load('content/'+item+'.html', load_callback(item));
	});
}
